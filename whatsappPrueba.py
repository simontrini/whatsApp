...
#cursor = bd.listar("select nombreCompleto, telefono FROM main.personas JOIN main.asistencia on main.personas.id = main.asistencia.persona_id and main.asistencia.actividad_id = 6")
##print(cursor)
#for fila in cursor:
...
#Invita a {0}35.
#"""
mensajes = """El 28 de febrero seguimos en la calle. 
Los Altos Mirandinos Unidos
Los Teques-Carrizal-San Antonio. {0} MAD eres tú.
